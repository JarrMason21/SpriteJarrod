 ...
 */
/*
This class is responsible for running the game. It contains a list of sprites
and allows for the creation of new sprites to be added to the game. While the game
is running it will repeat this process until terminated:

    1.Find all the sprites
    2.Move those sprites
